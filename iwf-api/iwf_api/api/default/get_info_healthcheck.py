...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[HealthInfo]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[HealthInfo]:
    return Response(
