...
class WorkflowStateOptions:
    ...
    wait_until_api_search_attributes_loading_policy: Union[Unset, "PersistenceLoadingPolicy"] = UNSET
    execute_api_search_attributes_loading_policy: Union[Unset, "PersistenceLoadingPolicy"] = UNSET
    data_attributes_loading_policy: Union[Unset, "PersistenceLoadingPolicy"] = UNSET
    wait_until_api_data_attributes_loading_policy: Union[Unset, "PersistenceLoadingPolicy"] = UNSET
    execute_api_data_attributes_loading_policy: Union[Unset, "PersistenceLoadingPolicy"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        wait_until_api_search_attributes_loading_policy: Union[Unset, dict[str, Any]] = UNSET
        ...
        execute_api_search_attributes_loading_policy: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.execute_api_search_attributes_loading_policy, Unset):
            execute_api_search_attributes_loading_policy = self.execute_api_search_attributes_loading_policy.to_dict()
        ...
        wait_until_api_data_attributes_loading_policy: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.wait_until_api_data_attributes_loading_policy, Unset):
            wait_until_api_data_attributes_loading_policy = self.wait_until_api_data_attributes_loading_policy.to_dict()
        ...
        if not isinstance(self.execute_api_data_attributes_loading_policy, Unset):
            execute_api_data_attributes_loading_policy = self.execute_api_data_attributes_loading_policy.to_dict()
        ...
        if wait_until_api_search_attributes_loading_policy is not UNSET:
            field_dict["waitUntilApiSearchAttributesLoadingPolicy"] = wait_until_api_search_attributes_loading_policy
        if execute_api_search_attributes_loading_policy is not UNSET:
            field_dict["executeApiSearchAttributesLoadingPolicy"] = execute_api_search_attributes_loading_policy
        ...
        if wait_until_api_data_attributes_loading_policy is not UNSET:
            field_dict["waitUntilApiDataAttributesLoadingPolicy"] = wait_until_api_data_attributes_loading_policy
        if execute_api_data_attributes_loading_policy is not UNSET:
            field_dict["executeApiDataAttributesLoadingPolicy"] = execute_api_data_attributes_loading_policy
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _wait_until_api_search_attributes_loading_policy = d.pop("waitUntilApiSearchAttributesLoadingPolicy", UNSET)
        wait_until_api_search_attributes_loading_policy: Union[Unset, PersistenceLoadingPolicy]
        if isinstance(_wait_until_api_search_attributes_loading_policy, Unset):
            ...
            wait_until_api_search_attributes_loading_policy = PersistenceLoadingPolicy.from_dict(
                _wait_until_api_search_attributes_loading_policy
            )

        _execute_api_search_attributes_loading_policy = d.pop("executeApiSearchAttributesLoadingPolicy", UNSET)
        execute_api_search_attributes_loading_policy: Union[Unset, PersistenceLoadingPolicy]
        if isinstance(_execute_api_search_attributes_loading_policy, Unset):
            execute_api_search_attributes_loading_policy = UNSET
        else:
            execute_api_search_attributes_loading_policy = PersistenceLoadingPolicy.from_dict(
        ...
        _wait_until_api_data_attributes_loading_policy = d.pop("waitUntilApiDataAttributesLoadingPolicy", UNSET)
        wait_until_api_data_attributes_loading_policy: Union[Unset, PersistenceLoadingPolicy]
        if isinstance(_wait_until_api_data_attributes_loading_policy, Unset):
            wait_until_api_data_attributes_loading_policy = UNSET
        else:
            wait_until_api_data_attributes_loading_policy = PersistenceLoadingPolicy.from_dict(
                _wait_until_api_data_attributes_loading_policy
            )

        _execute_api_data_attributes_loading_policy = d.pop("executeApiDataAttributesLoadingPolicy", UNSET)
        execute_api_data_attributes_loading_policy: Union[Unset, PersistenceLoadingPolicy]
        if isinstance(_execute_api_data_attributes_loading_policy, Unset):
            execute_api_data_attributes_loading_policy = UNSET
        else:
            execute_api_data_attributes_loading_policy = PersistenceLoadingPolicy.from_dict(
